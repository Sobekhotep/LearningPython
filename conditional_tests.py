...
def run():
    ...
    test_list = ['one', 'two', 'three', 'four', 'five', 'nail', 'rabbit',
                 'Obi-Van', 'neutron', 42, 'year', 'obstacle', 'ONE', 'TWO',
                 'NAIL', '42', 'tibbar', 'SEVEN']

    if first_string.lower() == fourth_string.lower() or third_string > \
            fourth_string and tird_string != fourth_string:
